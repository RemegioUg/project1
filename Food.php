                ...
                <div class="manage-books">
                    <div class="card">
                        <div class="card-header">
                            <h2>Food Menu</h2>
                            <a href="Add-Food.php" class="nav-link">Add Food</a>
                        </div>
                        <div class="card-body">
                            <div class="bo"><?php
                                ...
                                <div class="img">
                                      ...
                                      <?php echo '<img src="data:image/jpeg;base6,'.base64_encode($row['image']).'" />'?>
                                ...
                                <div class="details">
                                    ...
                                    <h>Price</h>
                                    <p>UGX <?php echo $row["price"]; ?></p>
                                  
                                   <a href="#" style="font-weight: 900;" class="nav-link">Update</a>
                                  
                                   <?php echo ".<a href='delete_food.php?food_category=$id' class = 'btn nav-link text-danger mr-2'>Delete</a>";
