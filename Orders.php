    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="Login.php" class="nav-link"><i style="color: red;" class="fa fa-power-off fa-lg"></i><i>Log Out</i> </a>
                </li>
            </ul>
        </div>
    </div>
                                ...
                                <table width='100% '>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Meat, rice</td>
                                            <td>0778299052</td>
                                            <td>Management Lec 3</td>
                                            <td><a href="Details.php" style="font-weight: bolder;" class="nav-link">Details</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
